...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: pJqZWRX7WfGpPj/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__jForT)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__vxhMb)}
              />
            </React.Fragment>
          ),
