...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: daTiDeiVyFkilJ/component
import Select__Option from "../../Select__Option"; // plasmic-import: M7ExaJv6rSX4X2/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic_bayo.module.css"; // plasmic-import: b1W5dJMGgkpaNQ8tnw9w16/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: YmMs-iV102CG0x/css
import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: cWzArE0dSQD8C6/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: 8TlS7KBj5N_uZl/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option___1S4FY)}
            value={"value1"}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__dfM3H)}
            value={"value2"}
          >
            {"Option 2"}
          </Select__Option>
