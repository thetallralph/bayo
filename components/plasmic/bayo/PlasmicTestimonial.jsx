...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 77GB9XZLbzFJN/css
...
function PlasmicTestimonial__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column___2OdYi)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__oWmox)}>
            <p.PlasmicImg
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/bayo/images/smalljpg.jpeg",
                fullWidth: 160,
                fullHeight: 160,
          ...
          <div className={classNames(projectcss.all, sty.column__sCJym)}>
            <h5
