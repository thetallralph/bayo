...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 7o1EaqzIntGTp/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: 6BUElcB0OTZzjK/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: qvwIVYK2RzSKZN/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___51Gvq)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__f3E9M)}
                role={"img"}
              />
            ),
